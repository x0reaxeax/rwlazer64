 ...
 * @brief after A LOT of hyper-v kernel debugging, i noticed the stack containing 
 * garbage values, and for the love of flying spaghetti monster,
 * i coulnt figure out why (cuz im a retard). but after a meatball revelation,
 * i noticed the garbage values look very close to my made up guids, 
 * which i thought were randomly generated bytes.
 *
 * (yes CRZEFI has a comment next to these, saying "they shouldn'be important"....
 * well thanks to this hillbilly, i wasted days and nights debugging.
 * just kidding, it was totally my fault for rewriting something i didnt understand,
 * this file would not exist without CRZEFI <3)
 */
